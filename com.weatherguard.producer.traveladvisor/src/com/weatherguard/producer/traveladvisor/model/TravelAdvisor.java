...
public class TravelAdvisor {
    ...
    public TravelAdvisor(String category, List<String> destinations, List<String> activities, String safetyInfo) {
    ...
    public String toString() {
        ...
        sb.append("Travel Advisory for ").append(category).append(" travellers:\n");
        ...
        sb.append("Safety Advice: ").append(safetyInfo);
        return sb.toString();
    }
}